...
- **Endpoint**：`POST https://app-clke7l1q03k1-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
async function queryIsbnInfo(isbn: string): Promise<IsbnDetail[]> {
  const url = new URL("https://app-clke7l1q03k1-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
